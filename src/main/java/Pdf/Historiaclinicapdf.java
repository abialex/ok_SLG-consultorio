...
public class Historiaclinicapdf {
    ...
    public static  void ImprimirHistoriaClinica(Persona opersona) throws IOException {
        ...
        //Cabecera
        Table CabeceraParrafo1=new Table(new float[]{volumen * 4.4f,volumen * 0.6f});
        ...
        Table CabeceraParrafo2=new Table(new float[]{volumen * 4.4f,volumen * 0.6f});
        ...
        cellCabeceraParrafo2 = new Cell().add(new Paragraph(""+oHistoriaclinica.getFechainscripcion()).setBorderBottom(new SolidBorder(1f))).addStyle(styleTextCenter).addStyle(styleCell);
        CabeceraParrafo2.addCell(cellCabeceraParrafo2);
